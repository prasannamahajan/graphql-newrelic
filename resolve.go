...
func NewRouter() *tools.Router {
	...
	router.Query("Query.Rebels", func() (Faction, error) {
		return GetFaction("1"), nil
	})
	router.Query("Query.Empire", func() (Faction, error) {
	...
	router.Query("Mutation.IntroduceShip", func(m interface{}, args MutationIntroduceShipArgs) (interface{}, error) {
